...
%let ADServer = "192.168.56.250"; /* network name/address of   */
                                               /*   the AD server.          */
...
%let ADPerBaseDN ="ou=SGF12,dc=SGF12,dc=LOCAL"; /* Specify the Distinguished */
                                             /* Name in the LDAP hierarchy  */
                                             /* where People searches begin.*/

%let ADGrpBaseDN ="ou=SGF12,dc=SGF12,dc=LOCAL"; /* Specify the Distinguished */
                                             /* Name in the LDAP hierarchy  */
                                             /* where Group searches begin. */


%let ADBindUser = "sasextract";      /* Userid which will connect   */
                                             /* to the AD server and extract*/
                                             /* the information.            */
                                             
%let ADBindPW = "Admin123";                  /* Password for Userid above.  */
